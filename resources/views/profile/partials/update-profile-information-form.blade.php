<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div>
            <img class="w-12 h-12 rounded-full object-cover border-2 border-gray-300 shadow-sm" style="height: 100px;"
        ...
        <div>
            ...
            <x-text-input id="pseudo" name="pseudo" type="text"
                class="mt-1 block w-full bg-gray-800 text-gray-400 cursor-not-allowed border-none" :value="old('pseudo', $user->pseudo)"
